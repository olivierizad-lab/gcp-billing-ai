...
# from bq_agent.sub_agents.bqml.agent import root_agent as bqml_agent
# from bq_agent.sub_agents.bigquery.agent import database_agent
...
class TestAgents(unittest.IsolatedAsyncioTestCase): 
    ...
    async def test_ds_agent_can_be_called_from_root(self):
        ...
        query = "Could you give us the top 3 TLAs with the most cost spendings? Also report their costs. Display the output in tabular form."
