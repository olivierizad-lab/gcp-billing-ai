#!/usr/bin/env python3
"""
Interactive prompt mode for bq_agent_mick.
...
def query_agent(query_text, user_id="default_user"):
    ...
    if not REASONING_ENGINE_ID:
        ...
        print("\nPlease set it in bq_agent_mick/.env file with: REASONING_ENGINE_ID=your-id")
        print("To find your REASONING_ENGINE_ID, run: make list-deployments AGENT_NAME=bq_agent_mick")
        return None
...
def main():
    ...
    print("=" * 80)
    print("bq_agent_mick Interactive Mode")
    print("=" * 80)
    print()
