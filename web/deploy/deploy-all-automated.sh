...
echo "  1. Deploy your agents to Vertex AI Agent Engine (if not already deployed)"
echo "  2. Agents will be automatically discovered - no configuration needed!"
echo "  3. Test access with users from your domain"
echo ""
